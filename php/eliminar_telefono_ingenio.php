<?php 
	...
	if (isset($_POST["des"]) && $_POST["des"]!="") {
		...
		if ($_POST["des"]=="eliminar") {
			...
			try {
				$SQL="DELETE FROM telefonos_ingenio where id ='$_POST[elcorreo]'";
				$comando = Conexion::getInstance()->getDb()->prepare($SQL);
                $comando->execute();
                
                try {

                	$SQL2="DELETE FROM foranea_telefonos_ingenio where id_telefonos ='$_POST[elcorreo]'";
		...
		//Actualizar (UPDATE) -TABLA-
			...
			$SQL="UPDATE telefonos_ingenio SET nombre ='$_POST[telefono1]', direccion ='$_POST[nombre1]'where id = '$_POST[id]'";
			try {
