...
<script src="../js/pages/telefonos_empresa.js?id=<?php echo date('Yidisus') ?>"></script>
<script>
$(function(){ 
    Telefonos_empresa.init(); 
    $(document).on("submit", "#registro", function (e) {
        ...
        console.log("el formulario",datos);
            ...
            $.ajax({
                dataType: "json",
                method: "POST",
                url:'json/insertar_telefono_empresa.php',
                data : datos,
            }).done(function(msg) {
            ...
            if(msg.exito){
                ...
                NProgress.done();
                $(location).attr('href','actualizar_telefono_empresa.php?date=<?php echo date("Yhmsi") ?>&id=<?php echo $_GET[id] ?>');
