                                ...
                                if($row[estado] == '1'){
                                    ...
                                    <ul class='dropdown-menu dropdown-custom text-left'>
                                        ...
                                        <li>
                                            ...
                                            <a data-toggle='tooltip' data-correo ='$row[correo]' id = 'btn_recuperar' title='Recuperar Contraseña' href='javascript:void(0)'><i class='fa fa-key pull-right'></i>Recuperar Contraseña</a>
                                            <a href='javascript:void(0)' id='a2' data-estado = '2' data-id ='$row[correo]' data-toggle='tooltip' title='Desactivar' href='javascript:void(0)'><i class='fa fa-lock pull-right'></i>Desactivar Usuario</a>
                                        </li>
                                        <li class='divider'></li>
                                        <li>
                                            <a data-correo ='$row[correo]' id='btneliminar' data-toggle='tooltip' title='Eliminar' href='javascript:void(0)'><i class='fa fa-trash pull-right'></i>Eliminar Usuario</a>
                                        </li>
