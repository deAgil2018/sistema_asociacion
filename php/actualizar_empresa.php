        ...
        <table id="ecom-products" class="table table-bordered table-striped table-vcenter">
            <thead>
                <tr>
                    ...
                    <th class="text-left hidden-xs">Tipo de Empresa</th>
...
<script>
    $(function(){
        ...
        $(document).on("click", "#btneliminar", function (e) {
            ...
            $(document).on('click', "#btn_sip", function() {
                ...
                $.ajax({
                    dataType: "json",
                    method: "POST",
                    url:'json/eliminar_empresa_p.php',
                    data : get,
                }).done(function(msg) {
                    console.log(msg);
                     if(msg.exito[0]){
        ...
        $(document).on("click", "#btn_telefono", function (e) {
            ...
            $(location).attr('href','nuevo_telefono_empresa.php?id='+trader+'&date=<?php echo date("Yhmsi") ?>');
         ...
         $(document).on("click", "#btn_actualizar_telefono", function (e) {
            var elem=$(this);
            var trader =elem.attr('data-elid');
            $(location).attr('href','actualizar_telefono_empresa.php?id='+trader+'&date=<?php echo date("Yhmsi") ?>');
