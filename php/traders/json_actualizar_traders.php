...
<?php 
	...
	if (isset($_POST["elcorreo"]) && $_POST["elcorreo"]!="" || isset($_POST["correo"]) && $_POST["correo"]!="") {
		...
		//Actualizar (UPDATE) -TABLA-
			...
			try {
				$SQL="UPDATE traders SET nombre ='$_POST[nombre]', direccion ='$_POST[direccion]', telefono ='$_POST[telefono]', fax_ingresado = '$_POST[fax]', correo = '$_POST[email]',\"tax_id\" = '$_POST[tax]' where id = '$_POST[elid]'";
				$comando = Conexion::getInstance()->getDb()->prepare($SQL);
                $comando->execute();
