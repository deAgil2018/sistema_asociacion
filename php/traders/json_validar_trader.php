<?php 
    ...
    if ($_POST["ele"]=="1") {
        	$query_codigo = "SELECT correo as useres from traders where correo ='".$_POST[data]."'";
        	try {
            ...
            $query_codigo = "SELECT correo as useres from traders where correo ='".$_POST[data]."' and correo<>'".$_POST[email_anterior]."' ";
            try {
                $comando = Conexion::getInstance()->getDb()->prepare($query_codigo);
                $comando->execute();
