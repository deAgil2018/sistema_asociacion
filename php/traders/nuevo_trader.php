                ...
                <div class="block-title">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="email" id="email" autocomplete="off" onblur="validar(this)" name="email" class="form-control" placeholder="Ingrese el correo">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            <div class="col-xs-12">
                                <label for="direccion">Dirección(*):</label>
                                <textarea id="direccion" name="direccion" rows="1" class="form-control" placeholder="Ingrese la dirección"></textarea>    
                            </div>    
                    </div>
