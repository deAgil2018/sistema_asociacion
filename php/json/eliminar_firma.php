<?php 
	...
	if (isset($_POST["des"]) && $_POST["des"]!="") {
		...
		if ($_POST["des"]=="eliminar") {
			...
			try {
				$SQL="DELETE FROM firmas_ingenio where id ='$_POST[elcorreo]'";
				$comando = Conexion::getInstance()->getDb()->prepare($SQL);
                $comando->execute();
                
                try {

                	$SQL2="DELETE FROM foranea_firmas_ingenio where id_firmas ='$_POST[elcorreo]'";
		...
		//Actualizar (UPDATE) -TABLA-
			...
			$SQL="UPDATE firmas_ingenio SET firma ='$_POST[firma1]', nombre ='$_POST[nombre1]'where id = '$_POST[id]'";
			try {
