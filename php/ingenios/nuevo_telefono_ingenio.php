...
<script src="../../js/pages/telefono_ingenio.js?id=<?php echo date('Yidisus') ?>"></script>
<script>
$(function(){ 
    Telefono_ingenio.init(); 
    $(document).on("submit", "#registro", function (e) {
        ...
        console.log("el formulario",datos);
            ...
            $.ajax({
                dataType: "json",
                method: "POST",
                url:'json/insertar_telefono.php',
                data : datos,
            }).done(function(msg) {
            ...
            if(msg.exito){
                ...
                NProgress.done();
                $(location).attr('href','actualizar_telefono_ingenio.php?date=<?php echo date("Yhmsi") ?>&id=<?php echo $_GET[id] ?>');
