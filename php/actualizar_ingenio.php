                            ...
                            echo"<td>$row[nit]</td>";
                                    ...
                                    <ul class='dropdown-menu dropdown-custom text-left'>
                                        ...
                                        <li>
                                            ...
                                            <a data-correo ='$row[correo]' data-elid='$row[id]' id='btn_telefono' data-toggle='tooltip' title='Agregar telefono' href='javascript:void(0)'><i class='fa fa-plus pull-right'></i>Agregar Telefono</a>
...
<script>
    $(function(){
        ...
        $(document).on("click", "#btn_telefono", function (e) {
            ...
            $(location).attr('href','nuevo_telefono_ingenio.php?id='+trader+'&date=<?php echo date("Yhmsi") ?>');
