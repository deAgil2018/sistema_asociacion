...
<script src="../../js/pages/operadores_carga.js?id=<?php echo date('Yidisus') ?>"></script>
<script>
$(function(){ 
    Operadores_carga.init(); 
    $(document).on("submit", "#registro", function (e) {
        ...
        console.log("el formulario",datos);
            ...
            $.ajax({
                dataType: "json",
                method: "POST",
                url:'insertar_operadores_carga.php',
                data : datos,
            }).done(function(msg) {
            ...
            if(msg.exito){
                ...
                $('#registro')[0].reset();
                NProgress.done();
                $(location).attr('href','actualizar_operadores_carga.php?date=<?php echo date("Yhmsi") ?>');
