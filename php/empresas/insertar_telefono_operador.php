<?php 
	...
	$estado = '1';
	$query = "INSERT INTO telefonos_operadores_carga(\"nombre\", \"telefono\", \"codigo_oculto\")values(?,?,?)";

	$query1 = "INSERT INTO foranea_telefonos_operadores_carga(\"id_telefonos\",\"id_empresa\")values(?,?)";
	...
	try {
        ...
        //codigo 
        $select_tel = "SELECT id from telefonos_operadores_carga where codigo_oculto='".$codigo_oculto."'";
