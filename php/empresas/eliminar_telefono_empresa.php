<?php 
	...
	if (isset($_POST["des"]) && $_POST["des"]!="") {
		...
		if ($_POST["des"]=="eliminar") {
			...
			try {
				$SQL="DELETE FROM telefonos_empresa where id ='$_POST[elcorreo]'";
				$comando = Conexion::getInstance()->getDb()->prepare($SQL);
                $comando->execute();
                
                try {

                	$SQL2="DELETE FROM foranea_telefonos_empresa where id_telefonos ='$_POST[elcorreo]'";
		...
		//Actualizar (UPDATE) -TABLA-
			...
			$SQL="UPDATE telefonos_empresa SET telefono ='$_POST[telefono1]', nombre ='$_POST[nombre1]'where id = '$_POST[id]'";
			try {
