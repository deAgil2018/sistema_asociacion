                        ...
                        while ($row = $comando->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo"<td>$row[firma]</td>";
                                    ...
                                    <ul class='dropdown-menu dropdown-custom text-left'>
                                        ...
                                        <li>
                                        <a id='a1' data-iid ='$row[id]' data-telefono='$row[firma]' data-nombre ='$row[nombre]'  data-id ='$row[id]' data-toggle='tooltip' title='Editar' href='javascript:void(0)' data-toggle='modal' ><i class='fa fa-pencil pull-right'></i>Editar Firma</a>

                                        </li>
                                        <li class='divider'></li>
                                        <li>
                                        <a data-correo ='$row[id]' id='btneliminar' data-toggle='tooltip' href='javascript:void(0)' title='Eliminar' ><i class='fa fa-trash pull-right'></i>Eliminar Firma</a>
                                        </li>
                            ...
                            <div class="col-md-6">
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Información del</strong> Firmante</h2>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Información de la</strong> Firma</h2>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input data-toggle="tooltip" title="Este campo solo permite letras mayusculas, minusculas, numeros y espacios!" type="text" id="firma1" name="firma1" class="form-control" placeholder="Ingrese contactos" autocomplete="off">  
                                            </div>  
                                        </div>
...
<script>
    $(function(){
        ...
        $(document).on("click", "#a1", function (e) {
            ...
            $("#firma1").val(elem.attr('data-telefono'));
